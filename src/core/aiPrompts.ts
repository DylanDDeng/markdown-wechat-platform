...
### 斜体样式
\`\`\`html
<em style="color:#5f5355;font-style:italic;">补充说明文字</em>
\`\`\`
规则：
- 斜体只用于补充说明、语气转折、轻旁注，不要大段连续使用
- 斜体默认使用偏暖深灰文字，例如 #5f5355，保持黑红刊刻风的克制感
- 斜体不要叠加浅红底条、浅黄底条或深红下划线
- 如果一句话已经用了斜体，就不要再同时做粗体强调，避免语气过重

### 粗体样式
\`\`\`html
<strong style="color:#1f1f1f;font-weight:700;">重点词</strong>
\`\`\`
规则：
- 普通粗体用于“需要提气但不需要高亮”的重点词或短语
- 粗体默认保持近黑文字，不自动变红，不自动加底色
- 若一个词已经用了深红文字强调、底条高亮或下划线强调，就不要再叠加普通粗体
- 普通粗体优先用于次级强调；更强的重点仍然交给下划线、底条高亮和深红文字系统
...
- 普通粗体和斜体属于辅助语气层，不计入“至少 3 种强调样式”的统计
