...
function buildTemplateStyles(template: FixedTemplateDefinition): TemplateStyles {
  ...
  const codeBlock = isMinimal
    ...
    : isJournal
      ...
      : isCyberNeon
        ? `margin:22px 0;padding:14px 16px;background:${palette.codeBackground};border-left:4px solid ${palette.codeBorder};border-radius:0 12px 12px 0;box-shadow:0 0 20px rgba(0,255,136,0.15),inset 0 0 20px rgba(0,255,136,0.05);overflow-x:auto;`
        : isPaperCraft
  ...
  return {
    root: `font-family:${bodyFont};background:${palette.background};color:${palette.text};font-size:15px;line-height:${
      ...
      isCyberNeon ? 'box-shadow:0 0 30px rgba(0,255,136,0.12),inset 0 0 60px rgba(0,255,136,0.03);' : 
    ...
    heading: {
      1: isEditorial
        ...
        : isMinimal
          ...
          : isCyberNeon
            ? `margin:34px 0 16px;line-height:1.3;font-size:26px;font-weight:700;color:${palette.accent};text-shadow:0 0 20px rgba(0,255,136,0.5);${headingFont}`
            : isPaperCraft
      ...
      2: isEditorial
        ...
        : isMinimal
          ...
          : isCyberNeon
            ? `margin:28px 0 12px;display:inline-block;padding:10px 20px;background:linear-gradient(135deg,${palette.accentSoft},#0d2a1a);border-left:4px solid ${palette.accent};border-radius:0 24px 24px 0;font-size:20px;font-weight:700;color:${palette.accent};text-shadow:0 0 10px rgba(0,255,136,0.3);${headingFont}`
            : isPaperCraft
    ...
    strong: isCyberNeon
      ? `color:${palette.accent};font-weight:700;text-shadow:0 0 8px rgba(0,255,136,0.4);`
      : isPaperCraft
    ...
    blockquote: isCyberNeon
      ? `margin:22px 0;padding:14px 18px;border-left:3px solid ${palette.quoteBorder};background:${palette.quoteBackground};border-radius:0 12px 12px 0;box-shadow:0 0 15px rgba(0,204,106,0.2),inset 0 0 20px rgba(0,204,106,0.05);`
      : isPaperCraft
